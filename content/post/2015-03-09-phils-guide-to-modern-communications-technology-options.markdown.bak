...
<td colspan="4" >This is the original form of written correspondence. It is still useful and relatively secure from eavesdropping, provided you didn't compose the letter on a computer to start with.
</td>
</tr>
<tr bgcolor="lightgray" >
Telephone (phone)
...
<td colspan="4" >What one gains in instantaneous communications, one loses in the ability to compose thoughts before communicating them. Use this method when you have to have a conversation with another person involving a lot of words and back-and-forth. Assume everything you say is being monitored or recorded unless you are using a VoIP service like [Ostel](https://ostel.co/).
</td>
</tr>
<tr bgcolor="lightgray" >
Faxsimile (fax)
...
<td colspan="4" >Don't use this anymore. Just don't. Stop it. Stop. Stop using fax.
</td>
</tr>
<tr bgcolor="lightgray" >
Email
...
<td colspan="4" >Can (and should) be secured using OTR (Off-The Record) encryption technology. If using Google's service, they will keep your chat messages, possibly forever. Can be very fast, depending on the participant's speed in typing. Best for interruptible and informal conversations, especially in an office or other quiet environment where talking is discouraged but typing noise is not. Much faster than SMS assuming the users are using real computers with real keyboards.
</td>
</tr>
<tr bgcolor="lightgray" >
Walkie Talkie (PTT, Zello)
</tr>
<tr bgcolor="lightgray" >
...
<td colspan="4" >The speed of talking with the asynchronicity of texting. The best of both worlds, but unfortunately not secure when using popular apps. Also not suitable for office or other quiet environments. Best used while driving or when ever a two-way radio would come in handy.
</td>
</tr>
</tbody>
</table>
